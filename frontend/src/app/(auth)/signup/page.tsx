        ...
        >
          <div className="bg-black/60 p-8 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button onClick={() => { onSignupClick() }} className="relative text-white bg-gradient-to-b from-cyan-400 to-cyan-100 rounded-[6px] w-full text-sm h-[32px] p-[1px] overflow-hidden">
